...
<head>
    ...
    <title>HOLAPETZ - Enquiry</title>
    <link rel="icon" type="image/x-icon" href="assets/img/logo/metaImg.jpg"/>
            ...
            <nav id="topbar">
                <ul class="navbar-nav theme-brand flex-row  text-center">
                    ...
                    <li class="nav-item theme-text">
                        <a href="{{ url('/admin') }}" class="nav-link">  </a>
                    </li>
                </ul>
                                        ...
                                        <td class="text-center">
                                            <ul class="table-controls">
                                                <li><a href="#" class="bs-tooltip"
                                                        ...
                                                        data-original-title="delete"><i data-feather="trash"></i></a></li>
                                            </ul>
                                        </td>
                                    </tr>
