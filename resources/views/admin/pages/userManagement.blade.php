...
<head>
    ...
    <title>HOLAPETZ - User Management</title>
    ...
    <div class="header-container">
        <header class="header navbar navbar-expand-sm">
            ...
            <div class="nav-logo align-self-center">
                <a class="navbar-brand" href="{{ url('/admin') }}"> <img alt="logo" src="{{ asset('admin/assets/img/logo/holalogo1.png') }}"> <span
                ...
                <li class="nav-item dropdown user-profile-dropdown order-lg-0 order-1">
                    <a href="javascript:void(0);" class="nav-link dropdown-toggle user" id="user-profile-dropdown"
                        ...
                        <div class="media">
                            ...
                            <img src="{{ asset('admin/assets/img/logo/metaImg.jpg') }}" class="img-fluid" alt="admin-profile">
            ...
            <nav id="topbar">
                <ul class="navbar-nav theme-brand flex-row  text-center">
                    <li class="nav-item theme-logo">
                        <a href="{{ url('/admin') }}">
                            <img src="{{ asset('admin/assets/img/logo/holalogo1.png') }}" class="navbar-logo" alt="logo">
                        </a>
                    </li>
                    <li class="nav-item theme-text">
                        <a href="{{ url('/admin') }}" class="nav-link"> Holapetz </a>
                    </li>
                </ul>
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td class="text-center">
                                              <a href="{{ url('admin/viewUser') }}" class="bs-tooltip" data-toggle="tooltip"
