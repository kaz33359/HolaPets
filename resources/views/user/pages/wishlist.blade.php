                            ...
                            <div class="row margin-minus-b-30">
                                ...
                                <div class="col-lg-3 col-md-4 col-sm-6 col-xs-6 mb-6 pro-gl-content">
                                    <div class="ec-product-inner">
                                        ...
                                        <div class="ec-pro-content">
                                            <h5 class="ec-pro-title"><a href="productdetails.html">Full Sleeve
                                                    Shirt</a></h5>
                                ...
                                <div class="col-lg-3 col-md-4 col-sm-6 col-xs-6 mb-6 pro-gl-content">
                                    <div class="ec-product-inner">
                                        <div class="ec-pro-image-outer">
                                            <div class="ec-pro-image">
                                                <a href="productdetails.html" class="image">
                                                    <img class="main-image" src="assets/images/holapetz/pedigree.jpg"
                                                        alt="Product" />
                                                    <img class="hover-image" src="assets/images/holapetz/pedigree.jpg"
                                                        alt="Product" />
                                                </a>
                                                <span class="ec-com-remove ec-remove-wish"><a
                                                        href="javascript:void(0)">×</a></span>
                                        ...
                                        <div class="ec-pro-content">
                                            <h5 class="ec-pro-title"><a href="productdetails.html">Cute Baby
                                                    Toy's</a></h5>
                                            <div class="ec-pro-rating">
                                                <i class="ecicon eci-star fill"></i>
                                                <i class="ecicon eci-star fill"></i>
                                            ...
                                            <div class="ec-pro-option">
                                                <div class="ec-pro-color">
                                                    ...
                                                    <ul class="ec-opt-swatch ec-change-img">
                                                        <li class="active"><a href="#" class="ec-opt-clr-img"
                                                                data-src="assets/images/holapetz/pedigree.jpg"
                                                                data-src-hover="assets/images/holapetz/pedigree.jpg"
                                                                data-tooltip="Gray"><span
                                ...
                                <div class="col-lg-3 col-md-4 col-sm-6 col-xs-6 mb-6 pro-gl-content">
                                    <div class="ec-product-inner">
                                        ...
                                        <div class="ec-pro-content">
                                            <h5 class="ec-pro-title"><a href="productdetails.html">Jumbo Carry
                                                    Bag</a></h5>
                                            <div class="ec-pro-rating">
                                                <i class="ecicon eci-star fill"></i>
                                                <i class="ecicon eci-star fill"></i>
                                ...
                                <div class="col-lg-3 col-md-4 col-sm-6 col-xs-6 mb-6 pro-gl-content">
                                    <div class="ec-product-inner">
                                        ...
                                        <div class="ec-pro-content">
                                            <h5 class="ec-pro-title"><a href="productdetails.html">I smart watch
                                                    6gb</a></h5>
                                            <div class="ec-pro-rating">
                                                <i class="ecicon eci-star fill"></i>
                                                <i class="ecicon eci-star fill"></i>
