...
<head>
    ...
    <title>HOLAPETZ - Vendor Profile</title>
            ...
            <div class="layout-px-spacing">
                ...
                <div class="page-header">
                    <nav class="breadcrumb-one" aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="{{ url('admin/vendorManagement') }}">Vendor Management</a></li>
                            <li class="breadcrumb-item active" aria-current="page"><a href="#">Vendor Profile</a></li>
                        </ol>
                    </nav>
                </div>
                            ...
                            <table id="html5-extension" class="table style-3 table-hover non-hover" style="width:100%">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td class="text-center">
                                              <a href="{{ url('admin/viewProduct') }}" class="bs-tooltip" data-toggle="tooltip"
